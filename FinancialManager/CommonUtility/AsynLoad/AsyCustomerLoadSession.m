...
@interface AsyCustomerLoadSession()

@property (nonatomic, copy) SuccessBlock sucBlock;
@property (nonatomic, copy) FailedBlock faiBlock;
@end

@implementation AsyCustomerLoadSession

+ (instancetype)asyLoadInstance
{
    static AsyCustomerLoadSession * distance = nil;
    static dispatch_once_t once;
    dispatch_once(&once, ^{
       
        distance = [[AsyCustomerLoadSession alloc]init];
    });
