...
@interface MyCfgCategoryCustomerViewController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation MyCfgCategoryCustomerViewController
...
- (void)initView
{
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"MyCfgCell" bundle:nil] forCellReuseIdentifier:@"MyCfgCell"];
...
- (void)loadCustomerDatas
{
    ...
    [[XNCustomerServerModule defaultModule] getNewCustomerListForCustomerType:@"1" pageIndex:[NSString stringWithFormat:@"%ld", self.nPageIndex] pageSize:@"30" attenInvestType:self.attenInvestType nameOrMobile:@""];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (self.customerArr.count <= 0) {
        ...
        [customerCell showTitle:@"当前没有我的直推理财师" subTitle:@""];
    ...
    [cell showCfgInfo:[self.customerArr objectAtIndex:indexPath.row] type:self.attenInvestType];
    return cell;
