...
@implementation CSIMCustomerCell
...
{
    [self.statusImageView setImage:[UIImage imageNamed:selected?@"XN_Home_Invite_checked.png":@"XN_Home_Invite_unChecked.png"]];
}
@end
