...
@interface UserPasswordValidateCodeViewController ()<XNUserModuleObserver>
...
- (IBAction)clickFinished:(id)sender
{
    ...
    [[XNUserModule defaultModule] userResetLoginPasswordWithPhone:self.phoneNumber VCode:self.vCodeTextField.text NewPwd:self.passwordTextField.text];
...
- (void)XNUserModuleResetLoginPasswordDidReceive:(XNUserModule *)module
{
    ...
    [self.view showCustomWarnViewWithContent:@"成功找回密码" Completed:^{
        ...
        [_UI popToRootViewControllerDidHideNavigationBar:YES animated:YES];
