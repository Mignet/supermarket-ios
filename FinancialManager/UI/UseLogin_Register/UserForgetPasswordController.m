...
- (void)XNUserModuleVCodeDidReceive:(XNUserModule *)module
{
    ...
    UserPasswordValidateCodeViewController * ctrl = [[UserPasswordValidateCodeViewController alloc]initWithNibName:@"UserPasswordValidateCodeViewController" bundle:nil];
