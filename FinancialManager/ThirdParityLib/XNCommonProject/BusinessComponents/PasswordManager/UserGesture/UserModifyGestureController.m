...
@interface UserModifyGestureController ()<XNPasswordManagerObserver>
...
- (IBAction)clickConfirm:(id)sender
{
    ...
    [[XNPasswordManagerModule defaultModule] userVerifyLoginPassword:self.loginPasswordTextField.text];
